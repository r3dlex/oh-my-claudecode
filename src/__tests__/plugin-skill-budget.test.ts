...
function readPluginJson(): { skills?: unknown; agents?: unknown; commands?: unknown } {
  return JSON.parse(readFileSync(PLUGIN_JSON, 'utf-8')) as { skills?: unknown; agents?: unknown; commands?: unknown };
}
