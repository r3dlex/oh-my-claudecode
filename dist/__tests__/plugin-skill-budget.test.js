...
function skillPayloadBytes(root) {
...
describe('plugin skill context budget gate (issues #2943, #2986)', () => {
    ...
    it('materializes declared plugin command wrappers into cache sync targets', () => {
        ...
        try {
            ...
            const manifest = JSON.parse(readFileSync(join(targetRoot, '.claude-plugin', 'plugin.json'), 'utf-8'));
...
//# sourceMappingURL=plugin-skill-budget.test.js.map